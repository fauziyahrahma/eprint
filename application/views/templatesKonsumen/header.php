...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assetsKonsumen/plugins/jquery-bar-rating/dist/themes/fontawesome-stars.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assetsKonsumen/plugins/slick/slick/slick.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assetsKonsumen/plugins/bootstrap-select/dist/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assetsKonsumen/plugins/Magnific-Popup/dist/magnific-popup.css">
                    ...
                    <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                        <div class="header__actions">
                            ...
                            <?php else : ?>
								...
								">Profile, <b><?= $this->session->userdata('username') ?></b></a>
                                </div>
                                <div class="btn-group ps-dropdown">
        ...
        <nav class="navigation">
            <div class="container-fluid">
                <div class="navigation__column left">
                    <div class="header__logo"><a class="ps-logo" href="<?php echo base_url(); ?>"><img src="https://s0.bukalapak.com/hdr/58908731/normal/LOGO%20EGOAPTISSS_scaled.jpg" alt=""></a></div>
                </div>
...
$run_query = $this->db->query($query)->result();
?>
                        <li class="menu-item menu-item-has-children dropdown"><a href="#">Produk</a>
                            <ul class="sub-menu">
                                <li class="menu-item"><a href="<?= base_url('konsumen/') ?>pesan_pilihkat">Semua Produk</a></li>
                                <?php foreach ($run_query as $key) { ?>
                                <li class="menu-item"><a href="<?=site_url('konsumen/kategori/'.$key->id_kategori)?>"><?=$key->nama_kategori?></a></li>
                                <?php }?>
                                <!-- <li class="menu-item"><a href="contact-us.html">Almamater</a></li>
                                <li class="menu-item"><a href="contact-us.html">Jaket</a></li>
                                <li class="menu-item"><a href="contact-us.html">Polo</a></li>
                                <li class="menu-item"><a href="contact-us.html">Hoodie</a></li>
                                <li class="menu-item"><a href="contact-us.html">Kaos Lapangan</a></li>
                                <li class="menu-item"><a href="contact-us.html">Jersey</a></li>
                                <li class="menu-item"><a href="contact-us.html">Jas</a></li> -->
                            </ul>
                        </li>

                        <li class="menu-item menu-item-has-children dropdown"><a href="<?=base_url('konsumen/kontaks') ?>">Kontak</a>
                            <!--<ul class="sub-menu">
                        ...
                        <li class="menu-item menu-item-has-children dropdown"><a href="<?=site_url('konsumen/testimoni')?>">Testimoni</a>
                        ...
                        <div class="ps-cart__listing">
                                ...
                                foreach ($barang_keranjang as $item) : ?>
                                    ...
                                    <div class="ps-cart-item"><a class="ps-cart-item__close" href="<?= base_url(
                                        ...
                                        <div class="ps-cart-item__thumbnail">
                                            <img src="<?php echo base_url(); ?>assetsKonsumen/images/cart-preview/1.jpg" alt="">
                                        </div>
                            ...
                            <?php if ($this->session->userdata('id_user')) : ?>
                                ...
                                <div class="ps-cart__footer"><a class="ps-btn" href="<?= base_url(
                                                                                            'Konsumen/cart'
                                                                                        ) ?>">Lihat Keranjang<i class="ps-icon-arrow-left"></i></a>
                                </div>
                            <?php else : ?>
                            <?php endif; ?>
                        </div>
