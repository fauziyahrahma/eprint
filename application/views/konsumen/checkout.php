            ...
            <form class="ps-checkout__form" action="<?= base_url(
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 ">
                        ...
                        <?php }else{ echo $this->session->flashdata('danger'); }?>
                        ...
                        <div class="ps-checkout__billing">
                            ...
                            <div class="form-group form-group--inline">
                                ...
                                <input class="form-control" type="email" name="email" value="<?=$this->session->email?>" required>
                            </div>
                            <div class="form-group form-group--inline">
                            ...
                            <div class="form-group form-group--inline">
                                ...
                                <textarea class="form-control" rows="5" placeholder="" name="alamat" required><?=$this->session->alamat?></textarea>
                            </div>

                            <!-- <div class="form-group form-group--inline">
                                <label>Bukti Bayar<span>*</span>
                                </label>
                                <input type="file" tclass="form-control" rows="5" placeholder="" name="bukti_bayar" required>
                            </div> -->

                            <h3 class="mt-40"> Informasi Tambahan</h3>
                            <div class="form-group form-group--inline textarea">
                                <label>Catatan</label>
                                <textarea class="form-control" rows="5" placeholder="Notes about your order, e.g. special notes for delivery." name="notes"></textarea>
                            </div>
                        </div>
                    </div>
                            ...
                            <footer>
                                ...
                                <div class="form-group paypal">
                                    ...
                                    <div class="form-group form-group--inline">
                                        ...
                                        <select class="custom-select mb-2" id="inputGroupSelect01" name="pembayarann" required>
                                    ...
                                    <button class="ps-btn ps-btn--fullwidth">Proses Order<i class="ps-icon-next"></i></button>
                                </div>
                            </footer>
                        </div>
