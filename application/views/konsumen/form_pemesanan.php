                        ...
                        <form method="POST" action="<?= base_url(
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" min="0" class="form-control" id="" name="uk_s" value="0">
                                </div>
                                <div class="form-group col-md-4">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="file" class="form-control" id="inputPassword4" value="0" style="padding: 10px;" name="desain">
